        ...
        for (int i = 0; i <canchas.size() ; i++) {
            ...
            if (metodo==1) {
                ...
                if (canchas.get(i).getId_establecimiento().equals(buscar)){
                    ...
                    Cancha_Establecimiento a = new Cancha_Establecimiento(b.getId(),datos_establecimiento.get(0),datos_establecimiento.get(1),datos_establecimiento.get(2),"Num: "+b.getTamano());
                    canchas_bus.add(a);
                }
            }else{
